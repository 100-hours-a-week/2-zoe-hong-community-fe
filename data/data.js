...
export const postDetailData = [
  {
    ...
    title: 'KTB 커뮤니티에 오신 것을 환영합니다!',
    content:
      '안녕하세요, KTB 커뮤니티에 오신 것을 환영합니다! 이 공간은 서로의 아이디어와 경험을 나누는 곳입니다. 자유롭게 의견을 나누고 소통해주세요. 커뮤니티 가이드라인을 준수하며 모두가 존중받는 환경을 만들어 나가요. 여러분의 적극적인 참여를 기대합니다!',
  ...
  },
  {
    ...
    title: '3월 정기 모임 안내',
    content:
      "안녕하세요, 회원 여러분! 3월 정기 모임을 안내해 드립니다. 이번 모임은 3월 15일 토요일 오후 2시에 시청 근처 커뮤니티 센터에서 진행됩니다. 주제는 '지속 가능한 도시 생활'이며, 전문가 초청 강연과 그룹 토론이 있을 예정입니다. 간단한 다과도 준비되어 있으니 많은 참여 부탁드립니다. 참가 신청은 이 게시물 댓글로 해주세요!",
  ...
  },
  {
    ...
    title: '새로운 프로젝트 아이디어를 공유합니다',
    content:
      "최근에 생각한 지역 환경 개선 프로젝트 아이디어를 공유합니다. 우리 동네 공원을 더 활기차게 만들기 위한 '시민 정원사' 프로그램을 제안합니다. 매주 토요일마다 주민들이 모여 공원의 화단을 가꾸고, 계절별 꽃과 식물을 심는 활동입니다. 이를 통해 공동체 의식도 높이고, 환경도 개선할 수 있을 것 같습니다. 관심 있으신 분들의 의견이나 추가 아이디어를 댓글로 남겨주세요!",
  ...
  },
  {
    ...
    title: '독서 모임 참가자 모집',
    content:
      "매주 수요일 저녁 7시에 진행되는 독서 모임 참가자를 모집합니다. 이번 달에는 한국 현대 소설을 함께 읽고 이야기 나눌 예정입니다. 첫 번째 책은 김영하의 '살인자의 기억법'입니다. 책을 미리 읽어오시면 좋지만, 그렇지 않더라도 함께 이야기 나누는 자리에 참여하실 수 있습니다. 관심 있으신 분들은 댓글로 남겨주세요. 장소는 시립 도서관 스터디룸입니다.",
  ...
  },
  {
    ...
    title: '주말 등산 모임 안내',
    content:
      '이번 주말 등산 모임을 안내해 드립니다. 3월 9일 일요일 아침 8시, 북한산 국립공원 우이동 입구에서 만나 백운대 코스로 등산할 예정입니다. 초보자도 참여 가능한 코스이며, 약 4-5시간 소요될 예정입니다. 등산화, 간식, 물 등 기본 장비를 준비해주세요. 날씨가 변덕스러울 수 있으니 겉옷도 챙겨오시는 것이 좋습니다. 함께 자연을 즐기며 건강한 주말을 보내요!',
